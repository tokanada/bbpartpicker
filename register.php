...
if($pass != $passconf){
    ...
    header("refresh: 5; /~dtao/Homework3/register.html");
} else {
    if (preg_match($password_pattern, $pass)) {
        ...
        if($count == 0){
            ...
            echo "<script>alert('Username already taken');window.location = '/~dtao/Homework3/register.html';</script>";
        }
    } else {
        echo "<script>alert('Your password doesn't fulfill the requirements');window.location = '/~dtao/Homework3/register.html';</script>";
    }
}
