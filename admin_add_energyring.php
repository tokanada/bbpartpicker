...
$sql = "INSERT INTO EnergyRing (name, weight, attack, defense, stamina, quantity, generation, clone, spindirection, price, picture) VALUES ('" . $name . "','" . $weight . "','" . $attack . "','" . $defense . "','" . $stamina . "','" . $quantity . "','" . $generation . "','" . $clone . "','" . $spin_direction . "','" . $price . "','" . $image_location . "')" ;
